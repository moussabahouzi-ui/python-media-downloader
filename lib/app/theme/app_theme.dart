  ...
  static ColorScheme _fallbackScheme({
    ...
    if (isDark) {
      return ColorScheme.dark(
        ...
        onPrimary: const Color(0xFF561F09),
        primaryContainer: const Color(0xFF722C13),
        onPrimaryContainer: const Color(0xFFFFDBCE),
        secondary: AppColors.secondaryDark,
        onSecondary: const Color(0xFF2F2C22),
        secondaryContainer: const Color(0xFF4B4838),
        onSecondaryContainer: const Color(0xFFD5CFC2),
        tertiary: const Color(0xFFB6CCAB),
        onTertiary: const Color(0xFF22381C),
        error: AppColors.errorDark,
        onError: const Color(0xFF690005),
        errorContainer: const Color(0xFF93000A),
        onErrorContainer: const Color(0xFFFFDAD6),
        surface: amoled ? AppColors.surfaceAmoled : AppColors.surfaceDark,
        onSurface: const Color(0xFFEDE0DA),
        onSurfaceVariant: const Color(0xFFD8C2B9),
        outline: const Color(0xFFA08C84),
        outlineVariant: const Color(0xFF53433D),
      );
    }
    return ColorScheme.light(
      primary: AppColors.primaryLight,
      onPrimary: const Color(0xFFFFFFFF),
      primaryContainer: const Color(0xFFFFDBCE),
      onPrimaryContainer: const Color(0xFF3A0B00),
      secondary: AppColors.secondaryLight,
      onSecondary: const Color(0xFFFFFFFF),
      secondaryContainer: const Color(0xFFE0DACB),
      onSecondaryContainer: const Color(0xFF18140B),
      tertiary: const Color(0xFF52634B),
      ...
      onSurface: const Color(0xFF211A17),
      onSurfaceVariant: const Color(0xFF53433D),
    ...
    try {
      ...
      if (palette != null) {
        ...
        final scheme = ColorScheme(
          ...
          primary: Color(palette.primary.get(primaryTone)),
          onPrimary: Color(palette.primary.get(onPrimaryTone)),
          primaryContainer: Color(palette.primary.get(containerTone)),
          onPrimaryContainer: Color(palette.primary.get(onContainerTone)),
          secondary: Color(palette.secondary.get(primaryTone)),
          onSecondary: Color(palette.secondary.get(onPrimaryTone)),
          secondaryContainer: Color(palette.secondary.get(containerTone)),
          onSecondaryContainer: Color(palette.secondary.get(onContainerTone)),
          tertiary: Color(palette.tertiary.get(primaryTone)),
          onTertiary: Color(palette.tertiary.get(onPrimaryTone)),
          tertiaryContainer: Color(palette.tertiary.get(containerTone)),
          onTertiaryContainer: Color(palette.tertiary.get(onContainerTone)),
          error: Color(palette.error.get(primaryTone)),
          onError: Color(palette.error.get(onPrimaryTone)),
          errorContainer: Color(palette.error.get(containerTone)),
          onErrorContainer: Color(palette.error.get(onContainerTone)),
          surface: Color(palette.neutral.get(surfaceTone)),
          onSurface: Color(palette.neutral.get(onSurfaceTone)),
          onSurfaceVariant: Color(palette.neutralVariant.get(onSurfaceVariantTone)),
          outline: Color(palette.neutralVariant.get(outlineTone)),
          outlineVariant: Color(palette.neutralVariant.get(outlineVariantTone)),
          shadow: const Color(0xFF000000),
          scrim: const Color(0xFF000000),
          inverseSurface: Color(palette.neutral.get(isDark ? 90 : 20)),
          onInverseSurface: Color(palette.neutral.get(isDark ? 20 : 95)),
          inversePrimary: Color(palette.primary.get(isDark ? 40 : 80)),
          surfaceTint: Color(palette.primary.get(primaryTone)),
        );
        return scheme;
      }
    } catch (_) {
